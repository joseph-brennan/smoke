...
class User(db.Model):
    ...
    Extends SQLAlchemy Model [#f1]_ to define the ORM for a User of smoke.
    ...
    def __init__(self, **kwargs):
        ...
        Creates a user with a cryptographically hashed password through PassLib. [#f2]_

        Parameters:
            **kwargs: The keyword arguments passed to the SQLAlchemy Model [#f1]_ constructor (which this class inherits
                from)
        """        
